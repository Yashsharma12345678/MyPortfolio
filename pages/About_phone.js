...
function About_phone() {
  ...
  return (
    <div className="scene ">
      ...
      <h1 className=' text-blue-400 text-3xl text-center border-b-[0.2px] border-gray-900 p-3 font-bold '>About Me</h1>
    
      <div className=' '>
      <h3 className='text-gray-600 mt-8 text-lg ml-5'>I am 20 year old software developer. I have a serious passion for ui effects, animations, creative intuitive dynamic user experience</h3>
      </div>
