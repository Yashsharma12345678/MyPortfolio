...
function About() {
  ...
  return (
    <div className=" grid grid-cols-2  text-white bg-[#0C0E10]">
      ...
      <div className=''>
      <h3 className='text-gray-600 mt-8 text-lg mx-3 h-full '>I am 20 year old software developer. I have a serious passion for ui effects, animations, creative intuitive dynamic user experience . Well organished person, problem solver with high attention to detail</h3>
      </div>
      </div>
      </div>
      </div>
