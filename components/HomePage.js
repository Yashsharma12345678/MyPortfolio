...
import { modalState, settingstate } from "@/atoms/modalAtom";
...
function HomePage() {
  ...
  const [settingOpen,setSettingOpen] = useRecoilState(settingstate)
  ...
  return (
    <>
      <div className="flex flex-col text-gray-400 justify-center items-center">
        ...
        {/* <div onClick={() => setSettingOpen(true)} className="drawer cursor-pointer absolute -top-0 right-0">
          <Bars3Icon className=" w-5 opacity-80 " />
        </div> */}
        {/* text */}
